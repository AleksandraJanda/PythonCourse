...
#  is one of the letters in the chosen_word. Print "Right" if it
...
def create_hidden_word():
    ...
    print_text(hidden_word)

def check_hidden_word(guess):
    for letter_id in range(0,len(hidden_word)):
        if hidden_word[letter_id] == '_':
            if chosen_word[letter_id] == guess:
                hidden_word[letter_id] = guess
    print_text(hidden_word)
...
while '_' in hidden_word or count == 7:
...
if count < 7 and '_' not in hidden_word:
    print('Win!')
